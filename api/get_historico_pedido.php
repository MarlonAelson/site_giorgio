	...
	if(!$headerTkn || $headerTkn != $x_token){
		...
		if(!isset($_GET['id_pedido'])){
			...
			$query = "
				...
				FROM (
					(SELECT 
						hsl.id_pedido_historico_logistica id_historico,
						s.id_status id_status,
						hsl.dataehora dataehora_bruto,
					...
					GROUP BY 
					 ...
					 UNION ALL
					(SELECT 
						hsp.id_pedido_historico_pagamento id_historico,
						s.id_status id_status,
						hsp.dataehora dataehora_bruto,
				...
				ORDER BY 
					tipo_status,dataehora_bruto ASC, id_historico
